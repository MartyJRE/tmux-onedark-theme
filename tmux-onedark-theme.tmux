...
set "status-right" "#[fg=$onedark_green,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_green,bold] #{b:pane_current_path} #[fg=$onedark_yellow, bg=$onedark_green]#[fg=$onedark_red,bg=$onedark_yellow]"
